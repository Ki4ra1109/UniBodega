    ...
    cart.forEach(product => {
        ...
        item.innerHTML = `
            ...
            <button class="remove-item" data-id="${product.id}" aria-label="Eliminar producto">
                <img src="/UniBodega/img/icon-trash.png" alt="Eliminar" class="icon-trash">
            </button>
        `;
...
document.getElementById('finalizar-compra').addEventListener('click', () => {
    ...
    if (!isNaN(total)) {
        localStorage.setItem('totalCompra', total); // Guardar total en localStorage
    }
    window.location.href = '../html/pago.html'; // Redirigir a pago.html
});
